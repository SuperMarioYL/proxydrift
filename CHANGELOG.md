...
- `tests/test_align.py`、`tests/test_divergence.py`：lag 方向、缺口处理、旗标谓词各臂、负控制、窗口合并、嫌疑排序、内置回放与示例数据的 36 项测试。
...
- 中英双语 README、MIT LICENSE、VERSION 与 pyproject 版本锁定测试、CI（lint + 测试矩阵）与 tag 触发的 release 工作流、真实演示 GIF。
